...
[_GAME] = LAYOUT_planck_grid(
    ...
    KC_ESC,  KC_4,    KC_LALT, KC_LGUI, GRAISE,  KC_SPC,  KC_SPC,  KC_M,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
[_GAMERAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_P,    KC_COMM, KC_DOT,  KC_SLSH, KC_F11,  KC_F12,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,  COLEMAK,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
};
