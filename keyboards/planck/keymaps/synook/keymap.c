...
[_GAME] = LAYOUT_planck_grid(
    KC_ESC,  KC_1,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
    KC_TAB,  KC_2,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,
    KC_LSFT, KC_3,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_H,    KC_J,    KC_K,    KC_L,
    KC_LCTL, KC_4,    KC_LALT, KC_LGUI, GMERASE, KC_SPC,  KC_SPC,  KC_M,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
[_GAMERAISE] = LAYOUT_planck_grid(
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_BSPC,
    _______, _______, _______, KC_GRV,  KC_MINS, KC_EQL,  KC_SCLN, KC_QUOT, KC_LBRC, KC_RBRC, KC_BSLS, KC_ENT,
    _______, KC_P,    KC_F11,  KC_F12,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_COMM, KC_DOT,  KC_SLSH, FR_GAME,
